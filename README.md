...
**Evidentiary accounting layer for cognitive effort in the Agent-OS ecosystem**

> ⚠️ **Alpha Release**: This is v0.1.0-alpha.1. APIs may change before stable release. Feedback welcome!

The Value Ledger records and preserves value for cognitive work — including ideas, effort, time, novelty, failures, and strategic insights — even when outcomes are unsuccessful.
